...
import (
	...
	"github.com/gonzalogarahuetes/bookings-go/internal/handlers"
...
func run() (*driver.DB, error) {
	...
	db, err := driver.ConnectSQL("host=localhost port=5432 dbname=bookings user=gonzalogarcia password=")
	if err != nil {
